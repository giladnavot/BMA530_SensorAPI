...
int main(void)
{
    ...
    struct bma530_generic_interrupt_types conf[2];

    conf[0].generic_interrupt = BMA530_GEN_INT_1;
    conf[1].generic_interrupt = BMA530_GEN_INT_2;
    ...
    int_map.gen_int2_int_map = BMA530_GEN_INT2_INT_MAP_INT1;
